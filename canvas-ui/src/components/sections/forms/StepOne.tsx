...
export default function StepOne({ onNext }: StepOneProps) {
  ...
  return (
    <div className="text-white space-y-10">
      ...
      {/* TITLE */}
      <h3 className="text-3xl font-bold-heading">Brand Details</h3>
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          onChange={(e) => {
            ...
            if (value !== "other") setCustomCategory(""); // reset
          }}
          className="
            w-full px-4 py-3 rounded-xl bg-[#111]
        ...
        {/* If OTHER, ask for custom category */}
        {brandCategory === "other" && (
          <input
            type="text"
            ...
            onChange={(e) => {
              ...
              setBrandCategory(e.target.value); // override store
            }}
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="
            px-4 py-2 mt-2 rounded-lg bg-white/10 text-white
