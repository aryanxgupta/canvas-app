  ...
  return (
    <div className="flex flex-col h-full max-h-[80vh] text-white custom-scrollbar">
      ...
      <div className="flex-1 overflow-y-auto pr-2 flex flex-col gap-8 custom-scrollbar">
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className="w-full min-h-[120px] bg-[#111] border border-white/20 text-white placeholder-white/40 rounded-xl p-4 focus:border-violet-400 focus:ring-2 focus:ring-violet-400/40 transition resize-none"
      ...
      <div className="flex justify-between pt-6 mt-auto shrink-0 border-t border-white/10">
        ...
        <button
          onClick={onNext}
          className="px-6 py-3 rounded-xl bg-violet-300 text-black font-bold hover:bg-violet-400 active:scale-95 transition flex items-center justify-start gap-2 cursor-pointer"
        >
